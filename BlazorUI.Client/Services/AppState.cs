...
namespace BlazorUI.Client.Services
{
    public class AppState
    {
        ...
        public NavbarModel LoadSidebar()
        {
            ...
            menuList.Add(new NavbarItemModel { Caption = "控制面板", Link = "/", style = "icon-speedometer" });
            //menuList.Add(new NavbarItemModel { ItemType = NavbarItemType.TextOnly, Caption = "Theme" });
            menuList.Add(new NavbarItemModel { Caption = "计数器", Link = "/Counter", style = "icon-drop" });
